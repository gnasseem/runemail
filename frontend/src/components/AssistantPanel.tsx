...
export default function AssistantPanel({
  ...
  return (
    <>
      {/* Slide-out panel */}
      <div
        className={`fixed top-0 right-0 h-full w-[380px] bg-[var(--background)] border-l border-[var(--border)] shadow-2xl z-50 flex flex-col transition-transform duration-200 ${
